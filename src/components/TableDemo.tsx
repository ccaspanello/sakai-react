...
export const TableDemo = () => {
    ...
    const [customer1, setCustomer1] = useState<Customer[] | undefined>();
    const [customer2, setCustomer2] = useState<Customer[] | undefined>();
    const [customer3, setCustomer3] = useState<Customer[] | undefined>();
    ...
    const countryBodyTemplate = (data: Customer) => {
        return (
            <>
    ...
    const representativeBodyTemplate = (data: Customer) => {
        return (
            <>
    ...
    const statusBodyTemplate = (data:Customer) => {
        return (
            <>
    ...
    const activityBody = (data: Customer) => {
        return (
            <>
    ...
    const priceBodyTemplate = (data: Product) => {
        return (
            <>
    ...
    const reviewsBodyTemplate = (data: Product) => {
        return (
            <>
                <span className="p-column-title">Reviews</span>
                <Rating value={data.rating} disabled cancel={false} />
            </>
        );
    };

    const productStatusBodyTemplate = (data: Product) => {
        return (
            <>
                <span className="p-column-title">Status</span>
    ...
    const headerRowGroup = (data: Customer) => {
        return (
            <>
                <img alt={data.representative.name} src={`assets/demo/images/avatar/${data.representative.image}`} width="32" style={{ verticalAlign: 'middle' }} />
                <span style={{ marginLeft: '.5em', verticalAlign: 'middle' }} className="image-text">{data.representative.name}</span>
    ...
    const footerRowGroup = (data: Customer) => {
        return (
            <>
