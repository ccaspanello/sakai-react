...
export const InputDemo = () => {
    ...
    const [autoValue, setAutoValue] = useState<Country[]>([]);
    const [selectedAutoValue, setSelectedAutoValue] = useState(null);
    const [autoFilteredValue, setAutoFilteredValue] = useState<Country[]>([]);
    ...
    const searchCountry = (event: AutoCompleteCompleteMethodParams) => {
        setTimeout(() => {
            if (!event.query.trim().length) {
                ...
                setAutoFilteredValue(autoValue.filter((country: Country) => {
    ...
    const itemTemplate = (option: Country) => {
        return (
    ...
    const selectedItemTemplate = (option: Country) => {
        if (option) {
            return (
                ...
                <div className="card">
                    <div className="grid">
                        <div className="col-12">
                            ...
                            <Slider value={sliderValue} onChange={(e) => setSliderValue(parseInt(e.value.toString()))} />
                        </div>
                        <div className="col-12 md:col-6">
                            <h5>Rating</h5>
                            <Rating value={ratingValue} onChange={(e) => e.value ? setRatingValue(e.value) : setRatingValue(undefined) } />
                        </div>
                        <div className="col-12 md:col-6">
                            <h5>ColorPicker</h5>
