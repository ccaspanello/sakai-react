...
`}
                    ...
                    <h5>Structure</h5>
                    <p>Sakai consists of 2 main parts; the application layout and the resources. <b>App.tsx</b> inside src folder is the main component containing the template for the base layout
                            whereas required resources such as SASS structure for the layout are placed inside the <b>src/layout</b> folder.</p>

                    <h5>Template</h5>
                    <p>Main layout is the JSX template of the App.tsx, it is divided into a couple of child components such as topbar, profile, menu and footer. Here is render method of the
...
`}
                    ...
                    <h5>Menu</h5>
                    <p>Menu is a separate component defined in AppMenu.tsx file based on PrimeReact MenuModel API. In order to define the menuitems,
                    navigate to createMenu() method App.tsx file and define your own model as a nested structure. Here is the menu component from the demo application.
