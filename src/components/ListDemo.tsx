...
import {DataView, DataViewLayoutOptions, DataViewLayoutType, DataViewSortOrderType} from 'primereact/dataview';
            ...
            <div className="col-12">
                <div className="product-list-item">
                    ...
                    <div className="product-list-detail">
                        ...
                        <Rating value={data.rating} disabled cancel={false}></Rating>
