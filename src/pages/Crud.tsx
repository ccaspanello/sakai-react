...
export const Crud = () => {
    ...
    const onInputChange = (e: ChangeEvent<HTMLTextAreaElement | HTMLInputElement>, name: string) => {
    ...
    const codeBodyTemplate = (rowData: Country) => {
        return (
            <>
    ...
    const ratingBodyTemplate = (rowData: Product) => {
        return (
            <>
                ...
                <Rating value={rowData.rating} disabled cancel={false} />
            </>
        );
    }
